...
filtered_meta = json.load(open("data/filtered-meta.json", "r"))
...
with open("data/chosen.tsv", "w") as f:
    for line in data("data/filtered.tsv"):
...
with open("data/chosen-meta.json", "w") as fm:
